...
namespace nvinfer1
{
class __attribute__((visibility("default"))) YoloLayerPlugin : public nvinfer1::IPluginV2IOExt
{
public:
  ...
  void configurePlugin(
    PluginTensorDesc const * in, int32_t nbInput, PluginTensorDesc const * out,
...
private:
  void forwardGpu(
    const float * const * inputs, float * output, cudaStream_t stream,
    int mYoloV8netHeight, int mYoloV8NetWidth, int batchSize);
...
class __attribute__((visibility("default"))) YoloPluginCreator : public nvinfer1::IPluginCreator
{
public:
  YoloPluginCreator();
